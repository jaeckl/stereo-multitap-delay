...
public:
  LinearCrossfadeMixer(float alpha) : m_alpha(alpha) {}
  virtual SampleType mix(SampleType a, SampleType b) override {
...
public:
  LinearMixer(float alpha, float beta) : m_alpha(alpha), m_beta(beta) {}
  virtual SampleType mix(SampleType a, SampleType b) override {
